	...
	<main class="container pt-3 ">
		...
		<form class="bg-secondary bg-opacity-10 p-3 mb-4">
			...
			<div class="row mt-3">
				<div class="col">
					<label for="ta_question" class="form-label  text-primary">Votre question ici :</label>
					<textarea id="ta_question" class="form-control" rows="3"></textarea>
